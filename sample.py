...
# 图片相关参数
sample_conf.image_width = 90
sample_conf.image_height = 30
sample_conf.max_captcha = 4
sample_conf.image_suffix = "jpg"

# 验证码字符相关参数
sample_conf.char_set = [ '2', '3', '4', '5', '6', '7', '8',  'a', 'b', 'c', 'd', 'e', 'f', 'g', 'm', 'n','m', 'p', 'w', 'x', 'y','w']
...
sample_conf.remote_url = "https://www.ticketing.highspeed.mtr.com.hk/its/captcha.jpg?t=61"
